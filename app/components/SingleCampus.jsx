    ...
    return (
      <div>
        <div>
          ...
          <p>
            Student experience is a top priority at {campus.name}. We use data
            from our Learn platform and student feedback to make regular
            enhancements to every aspect of the program. Admiral programmers
            once said, “A ship in port is safe, but that is not what ships are
            built for. Sail out to sea and do new things.” Now there's nothing
            between you and an exciting career in technology.
          </p>
        </div>
        ...
        <div>
          <Link to={"/campuses"}>
            ...
            <ul>
              {" "}
              <font color="brown">campuses</font>{" "}
            </ul>{" "}
          </Link>
        </div>
        <div>
